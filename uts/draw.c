...
void print_polygon_save(int* polygon_save_sides, int (*polygon_save_points)[1000], int* polygon_save_color, int iter) {
    for (int i = 0; i < iter; i++) {
        print_polygon(polygon_save_sides[i], polygon_save_points[i], convertColorFromCode(polygon_save_color[i]));
    }
}
...
void print_circle_save(int (*circle_save_points)[3], int* circle_save_color, int iter) {
    for (int i = 0; i < iter; i++) {
        print_circle(circle_save_points[i][0], circle_save_points[i][1], circle_save_points[i][2], convertColorFromCode(circle_save_color[i]));
    }
}
...
void translation(int* polygon_save_sides, int (*polygon_save_points)[1000], int (*circle_save_points)[3], int* polygon_save_color, int* circle_save_color, int iter_polygon, int iter_circle, int dx, int dy) {
    ...
    print_polygon_save(polygon_save_sides, polygon_save_points, polygon_save_color, iter_polygon);
    print_circle_save(circle_save_points, circle_save_color, iter_circle);
}
